 ...
 *
 * Student name: Dylan Balata 3-7-16
 */
...
public class Hangman {
    ...
    public static String pickRandomWord(String[] dictionary) {
        int y = (int)(Math.random()*(dictionary.length+1));
     ...
     */
    public static boolean foundGuessedLetter(String word,
                                             char[] knownLetters,
                                             char guessedLetter) {
        int b = 0;
    ...
    public static void main(String[] args) {
        ...
        while(guesses > 0 && !isComplete(known)) {
            ...
            if(!foundGuessedLetter(word, known, letter)) {
